...
if __name__=="__main__":
    ...
    parser.add_argument("--fn_fa", default="/net/eichler/vol27/projects/human_diversity/nobackups/hsiehph/genomicData/EEElab/read_depth_genotyper/human_g1k_v37.fasta", help="reference genome fasta file (Default: %(default)s)")
    parser.add_argument("--GC_DTS", dest="fn_GC_DTS", default="/net/eichler/vol27/projects/human_diversity/nobackups/hsiehph/genomicData/EEElab/read_depth_genotyper/500_bp_slide_GC", help="GC tracks DTS file (Default: %(default)s")
    parser.add_argument("--DTS_contigs", dest='fn_DTS_contigs', default="/net/eichler/vol27/projects/human_diversity/nobackups/hsiehph/genomicData/EEElab/read_depth_genotyper/500_bp_windows.pkl.contigs", help="Contig sizes file (Default: %(default)s)")
    parser.add_argument("--dup_tabix", dest="fn_dup_tabix", default="/net/eichler/vol27/projects/human_diversity/nobackups/hsiehph/genomicData/EEElab/read_depth_genotyper/superdups.merged.bed.gz", help="Superdups tabix file (Default: %(default)s)")
