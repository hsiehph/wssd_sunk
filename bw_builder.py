...
if __name__=="__main__":
    ...
    opts.add_option('','--output_contigs',dest='output_contigs', default="/net/eichler/vol27/projects/human_diversity/nobackups/hsiehph/genomicData/EEElab/read_depth_genotyper/hg19_contigs.txt")
